...
While the primary intention of this task is to provide test coverage and documentation out on projecthydra's "continuous integration server":hudson.projecthydra.org, it can also be used locally to run tests without having to install and configure an instance of "hydra-jetty":https://github.com/projecthydra/hydra-jetty.
...
Or, if you want to index full text rather than just fields:
...
If you have an existing object in your repository, you can solrize it by passing it's pid:
...
For instance, if you have an object in your repository with the following RELS-EXT:

<pre>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="info:fedora/changeme:3">
    <hasModel xmlns="info:fedora/fedora-system:def/model#" rdf:resource="info:fedora/afmodel:MyObject"></hasModel>
  </rdf:Description>
</rdf:RDF>
</pre>

Solrizer-fedora will check to see if you have a matching ruby model call MyObject.  If you do, it will load it and add any specific solr fields specified.  So, assuming the following model:
...
And the following content of the properties datastream:
...
Your solr doc will include the following:
